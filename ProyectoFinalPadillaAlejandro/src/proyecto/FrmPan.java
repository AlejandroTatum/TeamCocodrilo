...
public class FrmPan extends javax.swing.JDialog {
    ...
    private void metodoLlenarDatosTabla() {
    ...
    private void metodoNuevaReceta() {
        ...
        if (data != null && !data.isEmpty()) {
            try {
                ...
                if (number > 0) {
                    ...
                    cr.metodoModificarIngrediente(posicion, nuevaCantidad);
    ...
    private void metodoSeleccionarFila() {
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        metodoLlenarDatosTabla();
        metodoNuevaReceta();
    }//GEN-LAST:event_btnModificarActionPerformed

    private void tblDatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDatosMouseClicked
        metodoSeleccionarFila();
        metodoNuevaReceta();
