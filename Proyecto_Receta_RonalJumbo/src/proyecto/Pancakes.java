 ...
 * @author ronal
 */
public class Pancakes extends javax.swing.JDialog {
    ...
    public Pancakes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        llenarTabla();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Pancakes dialog = new Pancakes(new javax.swing.JFrame(), true);
