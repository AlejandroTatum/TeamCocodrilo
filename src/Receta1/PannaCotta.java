...
public class PannaCotta extends javax.swing.JDialog {
    ...
    public PannaCotta(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(PannaCotta.class.getName()).log(Level.SEVERE, null, ex);
                }
                PannaCotta dialog = new PannaCotta(new javax.swing.JFrame(), true);
