 ...
 * @author ronal
 */
public class Frm_Pancakes extends javax.swing.JDialog {
    ...
    public Frm_Pancakes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pancakes");

        jLabel2.setText("Seleccione la cantidad a modificar:");
    ...
    private void tblDatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDatosMouseClicked
        ...
        if (selectedRow != -1) {
            ...
            try {
                ...
                System.out.println("Formato de número no válido para cantidad: " + cantidadStr);
            }
            DefaultTableModel modelModificar = (DefaultTableModel) tbtModificar.getModel();
            modelModificar.setRowCount(0);
            modelModificar.addRow(new Object[]{cantidad, nombre, unidad}); 
            System.out.println("Datos transferidos a tbtModificar:");
            System.out.println("Nombre: " + nombre + ", Cantidad: " + cantidad + ", Unidad: " + unidad);
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Frm_Pancakes dialog = new Frm_Pancakes(new javax.swing.JFrame(), true);
